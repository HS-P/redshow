...
class BerkeleyControlNode(Node):
    def __init__(self):
        ...
        self.ACTION_SCALE_POLICY = 4.0  # 학습 시 wheel action에 곱해진 스케일
        
        # 실제 적용할 Action Scale (Firmware Space)
        # 이 값이 학습 시와 다르면 Observation에서 보정 필요
        self.WHEEL_SCALE_DRIVE_BASE = 4.0  # 저속용 기본 스케일 # 16
        self.WHEEL_SCALE_DRIVE_HIGH = 4.0  # 고속용 스케일 (16 * 1.5) # 28
        self.WHEEL_SCALE_THRESHOLD = 6.0  # 고속 스케일 적용 임계값 (rad/s)
